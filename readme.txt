=== YAWP Utils ===
Contributors: rhashemian
Tags: email, find, replace, SearchReplace
Stable tag: 1.1
Tested up to: 6.0
Requires PHP: 5.6
Requires at least: 4.6
Donate link: https://www.paypal.me/rhashemian
License: GPLv2 or later

YAWP Utils - Yet Another WordPress Plugin - Adds 2 features to your WordPress install, Set Email Address and Search/Replace. 
...
Normal plugin install process. After activating it, look for the utils under the 'Settings' menu to configure them.

== Frequently Asked Questions ==

= Is this plugin free of charge? =

Yes, This is a cost-free and advertising-free plugin with fully functioning features. 

== Screenshots ==

1. Set Email Address Settings in Admin panel.
2. Search/Replace Settings in Admin panel. 
